...
/* ============================================================
   CONFIGURACIÓN SEO Y DATOS REALES DEL NEGOCIO
   Revisa especialmente el dominio, el correo y los horarios antes
   de publicar. Toda la información debe coincidir con Google Business
   Profile, el aviso legal y el contenido visible de la web.
   ============================================================ */
$siteName = 'Boticardo';
$legalName = 'Farmacia Mª Carmen Rozalén Escriche';
$siteUrl = 'https://boticardo.es'; // Cambia esta URL si el dominio definitivo es otro.
...
$email = 'hola@boticardo.es'; // Sustituye este correo si no es el definitivo.
...
// Añade estas imágenes con las dimensiones indicadas para mejorar LCP, CLS y las previsualizaciones sociales.
$heroImagePath = 'img/landing/...png';
...
/* ============================================================
   BASE DE DATOS
   En producción es preferible definir DB_HOST, DB_USER, DB_PASSWORD
   y DB_NAME como variables de entorno y no guardar credenciales aquí.
   ============================================================ */
...
try {
    ...
    $resultadoVendidos = $conn->query($sqlMasVendidos);

    while ($producto = $resultadoVendidos->fetch_assoc()) {
        $productosMasVendidos[] = $producto;
    }

    $resultadoVendidos->free();
    $conn->close();
} catch (Throwable $error) {
    // No se muestran datos técnicos al visitante. Revisa el log del servidor.
    error_log('Boticardo - Error al cargar productos: ' . $error->getMessage());
}

/* ============================================================
   DATOS ESTRUCTURADOS JSON-LD
   En la portada marcamos el negocio físico y la página web. El schema
   Product debe añadirse en cada ficha individual, no en esta cuadrícula.
   ============================================================ */
$pharmacySchema = [
    '@type' => 'Pharmacy',
    '@id' => $siteUrl . '/#pharmacy',
...
<head>
  ...
  <!-- Open Graph: previsualización al compartir la portada -->
  ...
  <!-- Twitter/X utiliza también las etiquetas Open Graph como respaldo -->
...
<body>
  ...
  <nav class="subnav" aria-label="Categorías principales">
    <div class="container">
      <ul class="subnav__list" role="list">
        ...
        <li class="subnav__item">
          <a href="/dermocos" class="subnav__link">
            <span class="subnav__link-icon" aria-hidden="true"></span>
            Dermocosméctica
          </a>
        </li>
        ...
        <li class="subnav__item">
          <a href="/ofertas" class="subnav__link">
            <span class="subnav__link-icon" aria-hidden="true"></span>
            Ofertas
            <span class="subnav__badge" aria-label="Sección con descuentos">-30%</span>
          </a>
        </li>
  ...
  <main id="main-content">
        ...
        <div class="hero__inner">
          ...
          <div class="hero__image-wrap">
            <?php if ($heroImageExists): ?>
              ...
              />
            <?php else: ?>
              <!-- Añade img/seo/farmacia-boticardo-manzanera.webp para reemplazar este placeholder. -->
        ...
        <ul class="trust-bar__list" role="list">
          ...
          <li class="trust-bar__item">
            ...
            <div class="trust-bar__text">
              <span class="trust-bar__title">Farmacéuticos colegiados</span>
              <span class="trust-bar__subtitle">Asesoramiento profesional garantizado</span>
            </div>
          </li>
          ...
          <li class="trust-bar__item">
            ...
            <div class="trust-bar__text">
              <span class="trust-bar__title">Envío en 24 horas</span>
              <span class="trust-bar__subtitle">Gratis en pedidos superiores a 39€</span>
            </div>
          </li>
          ...
          <li class="trust-bar__item">
            ...
            <div class="trust-bar__text">
              <span class="trust-bar__title">Devolución sin preguntas</span>
              <span class="trust-bar__subtitle">30 días para devolver tu pedido</span>
            </div>
          </li>
    ...
    <section class="advice" aria-labelledby="advice-title">
      <div class="container">

        <div class="section-header">
          <span class="section-header__eyebrow">Nuestros farmacéuticos te informan</span>
          <h2 class="section-header__title" id="advice-title">Consejo farmacéutico</h2>
          <p class="section-header__subtitle">Artículos de salud redactados por nuestro equipo de profesionales.</p>
        </div>

        <div class="advice__grid">

          <article class="advice-card">
            <div class="advice-card__image-wrap">
              <div class="advice-card__image-placeholder" aria-hidden="true"></div>
            </div>
            <div class="advice-card__body">
              <span class="advice-card__tag">Nutrición</span>
              <h3 class="advice-card__title">Las vitaminas que no deben faltarte este verano</h3>
              <p class="advice-card__excerpt">El calor aumenta las necesidades de ciertos micronutrientes. Te contamos cuáles son clave y cómo obtenerlos fácilmente.</p>
              <a href="/blog/vitaminas-verano" class="advice-card__link">
                Leer artículo
          ...
          <article class="advice-card">
            ...
            <div class="advice-card__body">
              <span class="advice-card__tag">Dermocosméctica</span>
              <h3 class="advice-card__title">Guía para elegir el protector solar según tu tipo de piel</h3>
              <p class="advice-card__excerpt">No todos los filtros solares son iguales. Aprende a leer el etiquetado y escoge el más adecuado para tu piel.</p>
              <a href="/blog/elegir-protector-solar" class="advice-card__link">
                Leer artículo
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
              </a>
            </div>
          ...
          <article class="advice-card">
            ...
            <div class="advice-card__body">
              <span class="advice-card__tag">Salud en casa</span>
              <h3 class="advice-card__title">Qué debe tener el botiquín familiar en verano</h3>
              <p class="advice-card__excerpt">Picaduras, quemaduras solares, golpes de calor. Prepara tu botiquín con lo esencial antes de salir de vacaciones.</p>
              <a href="/blog/botiquin-verano" class="advice-card__link">
                Leer artículo
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
              </a>
            </div>
      ...
      <div class="footer__grid">
        ...
        <div>
          ...
          <ul class="footer__links" role="list">
            ...
            <li><a href="/dermocosmetica" class="footer__link">Dermocosméctica</a></li>
