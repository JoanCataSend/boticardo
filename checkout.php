        ...
        <div class="container">
            ...
            <div class="checkout-layout">
                    ...
                    <section class="checkout-card">
                        ...
                        <div class="checkout-grid">
                            <div class="checkout-field checkout-field--full">
                                ...
                                <input id="nombre_envio" name="nombre_envio" type="text" value="<?= e((string) ($currentUser['nombre'] ?? '')) ?>" required maxlength="160" autocomplete="name">
                            </div>
                            ...
                            <div class="checkout-field">
                                ...
                                <input id="telefono_envio" name="telefono_envio" type="tel" required maxlength="30" autocomplete="tel" placeholder="Ej. 600 123 123">
                            </div>

                            <div class="checkout-field checkout-field--full">
                                <label for="direccion_envio">Dirección</label>
                                <input id="direccion_envio" name="direccion_envio" type="text" required maxlength="255" autocomplete="street-address" placeholder="Calle, número, piso...">
                            </div>

                            <div class="checkout-field">
                                <label for="codigo_postal">Código postal</label>
                                <input id="codigo_postal" name="codigo_postal" type="text" required maxlength="5" inputmode="numeric" autocomplete="postal-code">
                            </div>

                            <div class="checkout-field">
                                <label for="localidad">Localidad</label>
                                <input id="localidad" name="localidad" type="text" required maxlength="120" autocomplete="address-level2">
                            </div>

                            <div class="checkout-field checkout-field--full">
                                <label for="provincia">Provincia</label>
                                <input id="provincia" name="provincia" type="text" required maxlength="120" autocomplete="address-level1">
                            </div>
                        </div>
                    </section>
                ...
                <aside class="checkout-summary" aria-label="Resumen del pedido">
                    ...
                    <div class="checkout-summary__row">
                        <span>Envío</span>
                        <strong><?= $shippingCost === 0.0 ? 'Gratis' : number_format($shippingCost, 2, ',', '.') . ' €' ?></strong>
                    </div>
